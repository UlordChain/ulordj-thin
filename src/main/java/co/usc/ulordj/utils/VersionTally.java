 ...
 *
 * @see co.usc.ulordj.core.NetworkParameters#getMajorityWindow()
 * @see co.usc.ulordj.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see co.usc.ulordj.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */

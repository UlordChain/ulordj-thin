...
public class SendRequest {
     ...
     * RuntimeException).</p>
     */
    public UldTransaction tx;

    /**
     * When emptyWallet is set, all coins selected by the coin selector are sent to the first output in tx
     * (its value is ignored and set to {@link co.usc.ulordj.wallet.Wallet#getBalance()} - the fees required
     ...
     * {@link UldTransaction#REFERENCE_DEFAULT_MIN_TX_FEE}.</p>
     */
    ...
    /**
     * If not null, the {@link co.usc.ulordj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     *
     * <p>Be very careful when value is smaller than {@link UldTransaction#MIN_NONDUST_OUTPUT} as the transaction will
    ...
    public static SendRequest to(Address destination, Coin value) {
        ...
        req.tx = new UldTransaction(parameters);
    ...
    public static SendRequest forTx(UldTransaction tx) {
        SendRequest req = new SendRequest();
        req.tx = tx;
        return req;
    }

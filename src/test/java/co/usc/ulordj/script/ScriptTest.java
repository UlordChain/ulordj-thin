...
import co.usc.ulordj.script.Script.VerifyFlag;
...
import static co.usc.ulordj.script.ScriptOpCodes.OP_0;
import static co.usc.ulordj.script.ScriptOpCodes.OP_INVALIDOPCODE;
...
public class ScriptTest {
    ...
    public void testP2SHOutputScript() throws Exception {
        Address p2shAddress = Address.fromBase58(TestNet3Params.get(), "saxvYV4oy1eu9ZDotsh94F9xc6BqsqgcvT");

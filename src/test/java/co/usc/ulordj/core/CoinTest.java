...
import static co.usc.ulordj.core.NetworkParameters.MAX_MONEY;
...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 ULD", COIN.toFriendlyString());
        assertEquals("1.23 ULD", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 ULD", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 ULD", valueOf(1, 23).negate().toFriendlyString());
    }

...
import static co.usc.ulordj.core.Coin.CENT;
import static co.usc.ulordj.core.Coin.COIN;
import static co.usc.ulordj.core.Coin.SATOSHI;
import static co.usc.ulordj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.ULD.noCode();
    ...
    public void codeOrientation() throws Exception {
        assertEquals("ULD 0.00", MonetaryFormat.ULD.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 ULD", MonetaryFormat.ULD.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("ULD@0.00", MonetaryFormat.ULD.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UULD.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MULD.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MULD.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MULD.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MULD.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MULD.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MULD.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UULD.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UULD.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UULD.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UULD.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UULD.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UULD.parse("-1.0"));
